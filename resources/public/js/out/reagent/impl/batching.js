...
var or__19866__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__19866__auto__)){
return or__19866__auto__;
} else {
var or__19866__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__19866__auto____$1)){
return or__19866__auto____$1;
} else {
var or__19866__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__19866__auto____$2)){
return or__19866__auto____$2;
} else {
var or__19866__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__19866__auto____$3)){
return or__19866__auto____$3;
} else {
...
var n__20769__auto__ = a.length;
var i = (0);
while(true){
if((i < n__20769__auto__)){
var c_21290 = (a[i]);
if(cljs.core.truth_((c_21290["cljsIsDirty"]))){
(c_21290["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__20464__auto__,writer__20465__auto__,opt__20466__auto__){
return cljs.core._write.call(null,writer__20465__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__21294 = c;
var G__21294__$1 = (((G__21294 == null))?null:(G__21294["props"]));
if((G__21294__$1 == null)){
return null;
} else {
return (G__21294__$1["argv"]);
}
});
...
var G__21296_21297 = (c["cljsRatom"]);
if((G__21296_21297 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__21296_21297);
}
