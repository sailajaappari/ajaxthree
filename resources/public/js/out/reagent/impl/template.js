...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20464__auto__,writer__20465__auto__,opt__20466__auto__){
return cljs.core._write.call(null,writer__20465__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__19866__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__19866__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__19866__auto__)){
return or__19866__auto__;
} else {
...
var G__22015 = o;
(G__22015[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_22019 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_22019))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_22019)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__19854__auto__ = (node === document.activeElement);
if(and__19854__auto__){
var and__19854__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__19854__auto____$1)){
...
if(cljs.core.truth_((function (){var and__19854__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__22022 = jsprops;
(G__22022["defaultValue"] = value);

(G__22022["onChange"] = ((function (G__22022,v,value,on_change){
return (function (p1__22020_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22020_SHARP_);
});})(G__22022,v,value,on_change))
);
...
var vec__22024 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22024,(0),null);
var id = cljs.core.nth.call(null,vec__22024,(1),null);
var class$ = cljs.core.nth.call(null,vec__22024,(2),null);
...
var temp__4655__auto__ = (function (){var G__22028 = cljs.core.meta.call(null,v);
if((G__22028 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22028);
}
})();
if((temp__4655__auto__ == null)){
...
var jsprops = {"argv": v};
var G__22030_22031 = v;
var G__22030_22032__$1 = (((G__22030_22031 == null))?null:reagent.impl.template.key_from_vec.call(null,G__22030_22031));
if((G__22030_22032__$1 == null)){
} else {
(jsprops["key"] = G__22030_22032__$1);
}
...
var p = (function (){var temp__4655__auto__ = (function (){var G__22035 = cljs.core.meta.call(null,argv);
if((G__22035 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22035);
}
})();
if((temp__4655__auto__ == null)){
return jsprops;
...
var G__22036 = (((jsprops == null))?{}:jsprops);
(G__22036["key"] = key);
...
var G__22037 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22037;
continue;
}
} else {
...
var n__20769__auto___22038 = a.length;
var i_22039 = (0);
while(true){
if((i_22039 < n__20769__auto___22038)){
(a[i_22039] = reagent.impl.template.as_element.call(null,(a[i_22039])));
...
var a = cljs.core.into_array.call(null,s);
var n__20769__auto___22041 = a.length;
var i_22042 = (0);
while(true){
if((i_22042 < n__20769__auto___22041)){
var val_22043 = (a[i_22042]);
if((cljs.core.vector_QMARK_.call(null,val_22043)) && ((reagent.impl.template.key_from_vec.call(null,val_22043) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22042] = reagent.impl.template.as_element.call(null,val_22043));

var G__22044 = (i_22042 + (1));
i_22042 = G__22044;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__19854__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__19854__auto__){
return (ctx["no-key"]);
} else {
return and__19854__auto__;
...
var G__22046 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22046) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22046){
